;;; me-oksolar-light-theme.el --- an OKLab variant of Solarized light -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added:
...
(defgroup me-oksolar-light-theme nil
  "Options for the `me-oksolar-light' theme."
  :group 'doom-themes)

(defcustom me-oksolar-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'me-oksolar-light-theme
  :type 'boolean)

(defcustom me-oksolar-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'me-oksolar-light-theme
  :type 'boolean)

(defcustom me-oksolar-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme me-oksolar-light
  ...
  ((bg         '("#FBF7EF" "#FBF7EF" "white"        ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if me-oksolar-light-brighter-comments
   ...
   ;; custom categories
   (-modeline-bright me-oksolar-light-brighter-modeline)
   (-modeline-pad
    (when me-oksolar-light-padded-modeline
      (if (integerp me-oksolar-light-padded-modeline) me-oksolar-light-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if me-oksolar-light-brighter-comments
   ...
   ((line-number-current-line &override) :foreground fg :background region)
   (mode-line
...
;;; me-oksolar-light-theme.el ends here
