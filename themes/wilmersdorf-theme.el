...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-doc-face ((,class (:slant italic :foreground ,comment))))
   `(font-lock-function-name-face ((,class (:bold t :foreground ,func))))
   `(font-lock-keyword-face ((,class (:slant italic :foreground ,keyword))))
